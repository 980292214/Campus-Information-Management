...
public class Swagger2Config {
    ...
    public Docket webApiConfig(){
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //可以测试请求头中：输入token
                //.apis(RequestHandlerSelectors.withClassAnnotation(ApiOperation.class))//不生效，显示不出来6.14
                .apis(RequestHandlerSelectors.basePackage("com.le.myzhxy.controller"))
                //过滤掉admin路径下的所有页面
